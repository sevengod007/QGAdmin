...
import (
	"flag"
	"fmt"
	"github.com/YaoHuoMimosa/QGAdmin/utils/stop"
	"io"
	"math/rand"
	"net/http"
	"os"
	...
	"github.com/YaoHuoMimosa/QGAdmin/conf"
	"github.com/YaoHuoMimosa/QGAdmin/lib/state"
	"github.com/YaoHuoMimosa/QGAdmin/utils"
	// "github.com/YaoHuoMimosa/QGAdmin/gui"
	"github.com/YaoHuoMimosa/QGAdmin/lib"
	"github.com/YaoHuoMimosa/QGAdmin/model"
	"github.com/YaoHuoMimosa/QGAdmin/push"
	//"github.com/YaoHuoMimosa/QGAdmin/utils/update"
	"github.com/YaoHuoMimosa/QGAdmin/web"
)
...
func init() {
	...
	if !utils.CheckQuestionDB() {
		...
		//log.Errorln("题库文件不存在或已损坏，请手动前往 https://github.com/YaoHuoMimosa/QGAdmin/blob/main/conf/QuestionBank.db 下载并放入程序根目录")
	}
}
